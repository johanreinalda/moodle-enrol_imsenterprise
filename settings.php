 ...
 */
    ...
    $settings->add(new admin_setting_configcheckbox('enrol_imsenterprise/updateuserlastname',
    		get_string('update_userlastname', 'enrol_imsenterprise'), '', 0));

    $settings->add(new admin_setting_configcheckbox('enrol_imsenterprise/updateuseremails',
    		get_string('update_useremails', 'enrol_imsenterprise'), '', 0));

    $settings->add(new admin_setting_configcheckbox('enrol_imsenterprise/updateuserurls',
    		get_string('update_userurls', 'enrol_imsenterprise'), '', 0));
    ...
    $settings->add(new admin_setting_configselect('enrol_imsenterprise/defaultauthentication',
    		get_string('defaultauthentication', 'enrol_imsenterprise'), '', '', $auth_options));

    $settings->add(new admin_setting_configtext('enrol_imsenterprise/defaultmanualpassword',
    		get_string('defaultmanualpassword', 'enrol_imsenterprise'), '', ''));

    $settings->add(new admin_setting_configcheckbox('enrol_imsenterprise/forcepasswordchange',
    		get_string('forcepasswordchange', 'enrol_imsenterprise'), get_string('forcepasswordchangedescription', 'enrol_imsenterprise'), 0));
/**
 ...
 */
    ...
    $settings->add(new admin_setting_configtext('enrol_imsenterprise/truncatecoursecodes',
    		get_string('truncatecoursecodes', 'enrol_imsenterprise'), get_string('truncatecoursecodes_desc', 'enrol_imsenterprise'), 0, PARAM_INT, 2));
 ...
 */
    ...
    $settings->add(new admin_setting_configcheckbox('enrol_imsenterprise/snapshotunenrol',
    		get_string('snapshotunenrol', 'enrol_imsenterprise'), get_string('snapshotunenrol_desc', 'enrol_imsenterprise'), 0));

    $settings->add(new admin_setting_configcheckbox('enrol_imsenterprise/updatevisibility',
    		get_string('updatevisibility', 'enrol_imsenterprise'), get_string('updatevisibility_desc', 'enrol_imsenterprise'), 0));

    $settings->add(new admin_setting_configcheckbox('enrol_imsenterprise/coursenotenrollable',
    		get_string('coursenotenrollable', 'enrol_imsenterprise'), get_string('coursenotenrollable_desc', 'enrol_imsenterprise'), 0));
    
    $settings->add(new admin_setting_configcheckbox('enrol_imsenterprise/categoryvisible',
    		get_string('categoryvisible', 'enrol_imsenterprise'), get_string('categoryvisible_desc', 'enrol_imsenterprise'), 0));
