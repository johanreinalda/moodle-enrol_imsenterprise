 ...
 */
$string['update_userlastname'] = 'Update user last name from ims data';
$string['update_useremails'] = 'Update user emails from ims data';
$string['update_userurls'] = 'Update user urls from ims data';
$string['defaultmanualpassword'] = 'Default password for new \'manual\' accounts';
$string['snapshotunenrol'] = 'Allow <b>snapshot unenrol</b>';
$string['snapshotunenrol_desc'] = 'Allow <b>snapshot unenrol</b> of students if not present in incoming enrolment file.';
$string['useshortname'] = 'Use short name';
$string['useshortname_desc'] = 'Use the short description tag to map to the course short name and the long description tag to map to the course full name';
$string['updatevisibility'] = 'Update course visibility';
$string['updatevisibility_desc'] = 'Update availability of the course to students from ims data';
$string['updatefullname'] = 'Update fullname';
$string['updatefullname_desc'] = 'Update fullname of the course from ims data';
$string['updatesummary'] = 'Update summary';
$string['updatesummary_desc'] = 'Update summary of the course from ims data';
$string['updatecategory'] = 'Update category';
$string['updatecategory_desc'] = 'Update category of the course from ims data';
$string['updatestartdate'] = 'Update start date';
$string['updatestartdate_desc'] = 'Update start date of the course from ims data';
$string['coursenotenrollable'] = 'Create new courses as not enrollable';
$string['coursenotenrollable_desc'] = 'Create new courses as not enrollable';
$string['categoryvisible'] = 'New categories visible';
$string['categoryvisible_desc'] = 'Create new categories as visible';
$string['updateshortname'] = 'Update shortname';
$string['updateshortname_desc'] = 'Update shortname of the course from ims data';
$string['autohidecourse'] = 'Auto hide course';
$string['autohidecourse_desc'] = 'Auto hide course after end-of-course date';
$string['autohidecourseafterndays'] = 'Auto-hide grace period';
$string['autohidecourseafterndays_desc'] = 'Auto-hide course grace period in days after end date';
$string['autohidecoursehourtorun'] = 'Auto-hide run hour';
$string['autohidecoursehourtorun_desc'] = 'Set the hour to run course auto-hiding';
$string['autohidecourselastrun'] = 'Last auto-hide';
$string['autohidecourselastrun_desc'] = 'Last time course hiding ran';
$string['defaultauthentication'] = 'Default authentication for new accounts';
$string['forcepasswordchange'] = 'Force password change';
$string['forcepasswordchangedescription'] = 'If Manual authentication, force password change on first login';
